  ...
  return (
    ...
    <section className="max-w-2x1 mx-auto p-6">
     ...
     <div className="titleZone">
      ...
      <input type="text" className="border-solid  border-black border-2 size-xl mb-10 w-64 " placeholder="Enter your title"/>

      <textarea type="text" placeholder="Enter your description"  className="w-full px-4 py-2 border border-blue rounded-md focus:ring-yellow focus:border-blue mb-5"></textarea>
